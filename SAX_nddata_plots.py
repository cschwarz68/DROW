...
def main():
    ...
    for df in df_list:
        ...
        speed_plot(df, speed_sec,speed_ltr,speed_int)  #the speed_plot function runs very slow, but not sure the reason...  
...
def speed_plot(df, speed_sec, speed_ltr,speed_int):
    ...
    if trip_spd_count <= 28*fig_spd_count:
        ...
        plt.suptitle(path[-11:-4]+'_speed_bySec_P'+str(fig_spd_count),fontsize = 14)
...
def acc_plot(df,acc_sec, acc_ltr):  
    ...
    if trip_acc_count <= 28*fig_acc_count:
        ...
        plt.subplots_adjust(hspace=.3) 
        plt.suptitle(path[-11:-4]+'_acc_bySec_P'+str(fig_acc_count),fontsize = 14)
        plt.subplot(4,7,trip_acc_count-28*(fig_acc_count-1)) 
                              
        ct_list = [acc_ltr.count('a'),acc_ltr.count('b'),acc_ltr.count('c'),
            acc_ltr.count('d'),acc_ltr.count('e'),acc_ltr.count('f'),acc_ltr.count('g'),
            acc_ltr.count('h'),acc_ltr.count('i'),acc_ltr.count('j')]
        ...
        plt.bar(range(10), ct_list, align = 'center', tick_label=True, capsize = True)
...
def yaw_plot(df,yaw_sec, yaw_ltr):  
    ...
    if trip_yaw_count <= 28*fig_yaw_count:
        ...
        plt.subplots_adjust(hspace=.3) 
        plt.suptitle(path[-11:-4]+'_yaw_bySec_P'+str(fig_yaw_count),fontsize = 14)
        plt.subplot(4,7,trip_yaw_count-28*(fig_yaw_count-1)) 
                     
        ct_list = [yaw_ltr.count('a'),yaw_ltr.count('b'),yaw_ltr.count('c'),
            yaw_ltr.count('d'),yaw_ltr.count('e'),yaw_ltr.count('f'),yaw_ltr.count('g'),
            yaw_ltr.count('h'),yaw_ltr.count('i')]
        ...
        plt.bar(range(9), ct_list, align = 'center', tick_label=True, capsize = True)
