...
def main():
    for filename in filenames:
        ...
        df = pd.read_csv(filename, 
            usecols=['vtti.file_id','vtti.speed_network','vtti.accel_x','vtti.accel_y','vtti.gyro_z',
                    'vtti.lane_distance_off_center','vtti.speed_gps','vtti.prndl','TRACK1_TARGET_ID',
                    'computed.time_bin','vtti.alcohol_interior'])
        ...
        #filt gear position with deleting rows with parking, reversing, natural and invalid data                              
